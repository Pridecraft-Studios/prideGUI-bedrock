# PrideGUI Bedrock Edition: Light Mode

This is an official addon to [Pridepack](https://github.com/pridecraft-studios/pridepack-be) that
changes the Minecraft GUI to have a light theme, with LGBT details.
It is available for many versions, it will probably work on any older version you try.
The way bedrock works, all the GUI textures are still able to be modified in a single pack, which in
practice means you probably will be able to use it on the first version that even accepts texture packs.
...
We make Resource Packs and mods to add LGBT themed stuff to the game, while trying to not "overgay".
The main difference of our stuff compared to other LGBT Minecraft packs is that we know how to keep
the game from looking like someone vomited rainbows all over the place.
